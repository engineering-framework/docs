...
The **Knowledge Base** page (`/dashboard/knowledge`) is a simple search form:
...
For AI agents connected via the Framework MCP server, the `ask` tool wraps
...
place, see [The Document Review Workflow](/knowledge-base-review).
