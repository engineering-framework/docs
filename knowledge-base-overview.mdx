...
<Note>
  A CLI for directly and reliably ingesting content — for anyone who wants
  more control than the automatic trigger gives them, including AI
  assistants — is planned but not yet available. This page will be updated
  once it ships.
</Note>
