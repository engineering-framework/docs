...
- **Production**: ask your administrator for the deployed URL. The service is
  configured to deploy to fly.io as `engineeringframework-kbmcp`, i.e.
  `https://engineeringframework-kbmcp.fly.dev`, but confirm with your
  administrator before using this — deployment is tracked separately from
  this server's core functionality and may not be live for your organization
  yet.
